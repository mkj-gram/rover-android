...
/*
 The subclass of `Operation` from which all other operations should be derived. This class implements the requirements for asynchronous operations and adds Observers, which allows the operation to notify interested parties about operation state changes.
 */
