...
var TableRow = function (_Component) {
    ...
    _createClass(TableRow, [{
        ...
        value: function render() {
            ...
            var i = 0;
            var cells = _react2.default.Children.map(children, function (element) {
                var isFirst = i === 0;
        ...
        value: function getStyle() {
            ...
            if (isHead) {
                declarations = _extends({}, declarations, {
            ...
            if (isOver && onClick) {
                declarations = _extends({}, declarations, {
                    backgroundColor: _colors.straw
                });
            }

            return _extends({}, declarations, style);
        }
    }]);
...
TableRow.propTypes = {
    isHead: _react.PropTypes.bool.isRequired,
