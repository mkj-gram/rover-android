...
, alter campaign_type set not null
...
, alter campaign_status set not null
...
, alter segment_condition set not null
...
, alter notification_attachment_type set not null
...
, alter notification_tap_behavior_type set not null
, alter notification_tap_behavior_type type text
    using case notification_tap_behavior_type
      ...
      else 'OPEN_EXPERIENCE'
    end
, alter notification_tap_behavior_presentation_type set default 'UNKNOWN'
, alter notification_tap_behavior_presentation_type set not null
...
, alter scheduled_type set not null
...
, alter scheduled_delivery_status set not null
