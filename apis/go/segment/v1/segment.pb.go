...
type PushId struct {
	...
	Type PushIdType `protobuf:"varint,2,opt,name=type,enum=segment.v1.PushIdType" json:"type,omitempty"`
}
...
func init() {
	proto.RegisterType((*StaticSegment)(nil), "segment.v1.StaticSegment")
	proto.RegisterType((*ListStaticSegmentRequest)(nil), "segment.v1.ListStaticSegmentRequest")
	proto.RegisterType((*ListStaticSegmentResponse)(nil), "segment.v1.ListStaticSegmentResponse")
	proto.RegisterType((*GetStaticSegmentRequest)(nil), "segment.v1.GetStaticSegmentRequest")
	proto.RegisterType((*GetStaticSegmentReply)(nil), "segment.v1.GetStaticSegmentReply")
	proto.RegisterType((*CreateStaticSegmentRequest)(nil), "segment.v1.CreateStaticSegmentRequest")
	proto.RegisterType((*CreateStaticSegmentReply)(nil), "segment.v1.CreateStaticSegmentReply")
	proto.RegisterType((*UpdateStaticSegmentIdsReply)(nil), "segment.v1.UpdateStaticSegmentIdsReply")
	proto.RegisterType((*GetStaticSegmentPushIdsRequest)(nil), "segment.v1.GetStaticSegmentPushIdsRequest")
	proto.RegisterType((*PushId)(nil), "segment.v1.PushId")
	proto.RegisterEnum("segment.v1.PushIdType", PushIdType_name, PushIdType_value)
}
...
func (c *segmentClient) ListStaticSegments(ctx context.Context, in *ListStaticSegmentRequest, opts ...grpc.CallOption) (*ListStaticSegmentResponse, error) {
	...
	err := grpc.Invoke(ctx, "/segment.v1.Segment/ListStaticSegments", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *segmentClient) GetStaticSegment(ctx context.Context, in *GetStaticSegmentRequest, opts ...grpc.CallOption) (*GetStaticSegmentReply, error) {
	...
	err := grpc.Invoke(ctx, "/segment.v1.Segment/GetStaticSegment", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *segmentClient) CreateStaticSegment(ctx context.Context, in *CreateStaticSegmentRequest, opts ...grpc.CallOption) (*CreateStaticSegmentReply, error) {
	...
	err := grpc.Invoke(ctx, "/segment.v1.Segment/CreateStaticSegment", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *segmentClient) UpdateStaticSegmentPushIds(ctx context.Context, opts ...grpc.CallOption) (Segment_UpdateStaticSegmentPushIdsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Segment_serviceDesc.Streams[0], c.cc, "/segment.v1.Segment/UpdateStaticSegmentPushIds", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *segmentClient) GetStaticSegmentPushIds(ctx context.Context, in *GetStaticSegmentPushIdsRequest, opts ...grpc.CallOption) (Segment_GetStaticSegmentPushIdsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Segment_serviceDesc.Streams[1], c.cc, "/segment.v1.Segment/GetStaticSegmentPushIds", opts...)
	if err != nil {
		return nil, err
	}
...
func _Segment_ListStaticSegments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/segment.v1.Segment/ListStaticSegments",
	}
...
func _Segment_GetStaticSegment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/segment.v1.Segment/GetStaticSegment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Segment_CreateStaticSegment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/segment.v1.Segment/CreateStaticSegment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Segment_serviceDesc = grpc.ServiceDesc{
	ServiceName: "segment.v1.Segment",
...
var fileDescriptor0 = []byte{
	...
	,
}
