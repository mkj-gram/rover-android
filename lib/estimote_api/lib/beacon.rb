...
# settings"=>{"battery"=>100, "interval"=>950, "hardware"=>"D3.4", "firmware"=>"A3.0.1", "basic_power_mode"=>false, "smart_power_mode"=>true, "timezone"=>"America/Toronto", "scheduling"=>false, "scheduling_config"=>"0", "scheduling_period"=>"0", "security"=>false, "motion_detection"=>true, "conditional_broadcasting"=>"off", "latitude"=>nil, "longitude"=>nil, "place_id"=>nil, "clock_offset"=>nil, "created_at"=>"2016-01-19T17:08:22.190Z", "synced_at"=>"2016-01-19T17:08:22.160Z", "broadcasting_scheme"=>"estimote", "range"=>-12, "power"=>-12, "firmware_deprecated"=>false, "firmware_newest"=>true, "place"=>nil}, "color"=>"white", "context_id"=>165978, "name"=>"Red", "battery_life_expectancy_in_days"=>1168, "tags"=>[]}
