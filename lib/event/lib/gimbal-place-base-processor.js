...
class GimbalPlaceBaseProcessor extends BaseProcessor {
    ...
    constructor(args) {
        ...
        this._gimbalPlaceId = args.input['gimbal-place-id'];
    }
    ...
    getMessages(callback) {
        ...
        methods.proximityMessage.gimbalPlaceTriggered(this._account.id, this._eventId, this._timestamp, this._gimbalPlace, (err, messages) => {
            if (err) {
                return callback(err);
            }
