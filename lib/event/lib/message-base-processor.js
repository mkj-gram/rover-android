        ...
        if (this._messageId) {
            ...
            methods.message.find(this._messageId, {}, (err, message) => {
                ...
                if (message) {
                    ...
                    if (util.isString(message.customer_id) && message.customer_id != this._customer._id.toString()) {
                        return callback("This message does not belong to you");
                    } else if (!message.customer_id.equals(this._customer._id)) {
                        return callback("This message does not belong to you");
                    }
