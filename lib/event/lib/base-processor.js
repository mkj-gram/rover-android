...
class BaseProcessor {
        ...
        methods.message.bulkInsert(messages, (err, insertedMessages) => {
            ...
            if (!util.isNullOrUndefined(this._device.token) && this._device.token !== "") {
                let pushPayload = {
                    ...
                    trigger_event_id: this._trigger_event_id,
            ...
            let messageEventPromises = inboxMessages.map(message => {
                ...
                Object.assign(event, triggerArgs);
    ...
    toRecord() {
        ...
        if (place) {
            ...
            event = Object.assign(event, placeRecord);
        }
        ...
        if (beaconConfiguration) {
            ...
            event = Object.assign(event, beaconConfigurationRecord);
        }
