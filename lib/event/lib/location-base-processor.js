...
class LocationBaseProcessor extends BaseProcessor {
    ...
    constructor(args) {
        ...
        this._accuracy = parseInt(args.input.accuracy || args.input.radius) || null;
    ...
    shouldProcessEvent(callback) {
        ...
        if (this._device.location) {
            ...
            let shouldProcess = this._device.os_name == "iOS" || distance > 5000 || (distanace >= 50 && this._location.accuracy <= 200)
