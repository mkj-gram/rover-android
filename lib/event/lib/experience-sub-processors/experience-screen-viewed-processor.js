...
class ExperienceScreenViewedProcessor extends ExperienceBaseProcessor {
    ...
    constructor(args) {
        ...
        this._fromScreenId = args.input["from-screen-id"];
        this._fromBlockId = args.input["from-block-id"];
    }
    ...
    toRecord() {
        ...
        record.experience.from_screen_id = this._fromScreenId;
        record.experience.from_block_id = this._fromBlockId
