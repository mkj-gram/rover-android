...
describe('Device', function() {
	...
	describe('fromProto toProto', function() {
		...
		describe('BoolValues', function() {
			it('defaults null BoolValues to false', function() {
		
				const input = {
					is_wifi_enabled: null,
					is_cellular_enabled: null,
					is_bluetooth_enabled: null
				}
			...
			it('preserves null BoolValues', function() {
				const input = {
					is_wifi_enabled: null,
					is_cellular_enabled: null,
					is_bluetooth_enabled: null
				...
				const exp = {
					is_wifi_enabled: undefined,
					is_cellular_enabled: undefined,
					is_bluetooth_enabled: undefined
				}

				const proto = AudienceProtobuf.UpdateDeviceRequest.deserializeBinary(Device.deviceContextToProto(1, "ABC", input).serializeBinary())
		...
		describe('DeviceUpdateRequest', function() {
			it('builds device context request', function() {
				...
				const got = {
					...
					is_wifi_enabled: proto.getIsWifiEnabled().getValue(),
					is_cellular_enabled: proto.getIsCellularEnabled().getValue(),
					...
					is_bluetooth_enabled: proto.getIsBluetoothEnabled().getValue(),
