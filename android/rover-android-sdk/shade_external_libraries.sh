...
rm -rf rover/src/main/java/io/rover/shaded
mkdir -p rover/src/main/java/io/rover/shaded
cp -R shade/extracted/zxing-zxing-3.3.1/core/src/main/java rover/src/main/java/io/rover/shaded/zxing
...
find rover/src/main/java/io/rover/shaded/zxing -type f -print0 | xargs -0 -I {} sed -i.bak s/com.google.zxing/io.rover.shaded.zxing.com.google.zxing/g {}
