...
func testAudienceServiceNotifications(t *testing.T) {
	...
	var exp = []service.Message{
		...
		{"account_id": "5", "event": "updated", "model": "profileSchema"},
		...
		{"account_id": "6", "event": "updated", "model": "profileSchema"},
		{"account_id": "20", "event": "updated", "model": "profile", "id": "aaaaaaaaaaaaaaaaaaaaaa20"},
		{"account_id": "20", "event": "updated", "model": "profileSchema"},
		{"account_id": "20", "event": "updated", "model": "profile", "id": "aaaaaaaaaaaaaaaaaaaaaa20"},
	...
	// logs notifications out
	if testing.Verbose() {
		for i, msg := range notifications.msgs {
			t.Logf("notification[%d]: %+v", i, msg)
		}
	}
}
