...
func DeviceV2Mapping(customDeviceAttributesMapping, customProfileAttributesMapping M) M {
	...
	return M{
		"device": M{
			...
			"properties": M{
				...
				// NOTE: ms-12: embedded profile
				"profile": M{
					"properties": profileProperties(customProfileAttributesMapping),
				},

				// NOTE: ms-12: embedded attributes
				"attributes": M{
					"properties": customDeviceAttributesMapping,
				},
...
func CustomAttributesMapping(attrs []*mongodb.SchemaAttribute) M {
	var mapping = M{}
...
func profileProperties(mapping M) M {
	return M{
		"id":         M{"type": "keyword"}, // {"$oid": "aaaaaaaaaaaaaaaaaaaaaa01"},
		"account_id": M{"type": "integer"},
		"identifier": M{"type": "keyword"}, // "78e19dbf-8c0b-47a5-b28f-444444444444",
