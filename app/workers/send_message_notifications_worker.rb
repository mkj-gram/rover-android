    ...
    def send_ios_notifications_to_customer(customer, messages, device_ids_filter)
        ...
        if rover_debug_devices.any?
            ...
            if rover_debug_production_devices.any?
                send_ios_notifications_with_connection(RoverApnsHelper.debug_production_connection, messages, rover_production_devices)
            end

            if rover_debug_development_devices.any?
                send_ios_notifications_with_connection(RoverApnsHelper.debug_development_connection, messages, rover_development_devices)
            end
        end
